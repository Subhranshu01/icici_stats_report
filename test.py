...
if __name__ == "__main__":
    ...
    fetch_and_store_metrics("PersonalLoan", PersonalLoan_url, API_TOKEN)
    fetch_and_store_metrics("MutualFund", MutualFund_url, API_TOKEN)
    fetch_and_store_metrics("FixedDeposit", FixedDeposit_url, API_TOKEN)
    ...
    fetch_and_store_metrics("HomeLoan", HomeLoan_url, API_TOKEN)
